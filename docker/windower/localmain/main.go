...
// deliberately lives outside src/windower: the Terraform archive_file zips that
...
import (
	...
	// Imported for its init(), which registers ProcessWindows with the
	// functions framework exactly as the deployed function does.
	_ "github.com/mardentub/windower"
)
